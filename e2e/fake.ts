...
/**
 * Seed the generator from a test's title, so the same test always makes the
 * same people, projects and prose, and two tests never share a sequence. The
 * names still read as real names; only their choice is fixed.
 */
