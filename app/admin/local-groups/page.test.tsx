...
describe('admin local groups', () => {
  it(
    'lists groups and suggestions, filters, adds, edits, reviews and deletes',
    { timeout: 20_000 },
    async () => {
      ...
      await userEvent.click(
        await screen.findByRole('option', { name: 'United Kingdom, Zz Bristol' }),
      )
      await userEvent.click(screen.getByRole('button', { name: 'Confirm' }))
      ...
      await waitFor(() =>
        expect(article('United Kingdom, Zz Bruton')).toHaveTextContent('Declined'),
      )
      void toHold
