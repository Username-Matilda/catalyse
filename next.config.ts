...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: '/static/admin/volunteer-detail.html', destination: '/admin/triage', permanent: false },
      // Static routes
      ...
      { source: '/static/admin/create-project.html', destination: '/admin/projects/new', permanent: false },
      { source: '/static/admin/skills.html', destination: '/admin/skills', permanent: false },
      { source: '/static/admin/starter-tasks.html', destination: '/admin/starter-tasks', permanent: false },
