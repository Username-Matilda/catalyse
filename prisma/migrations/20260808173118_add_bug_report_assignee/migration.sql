...
INSERT INTO "new_bug_reports" ("category", "created_at", "description", "github_issue_url", "id", "page_url", "reporter_email", "reporter_id", "resolution_notes", "resolved_at", "resolved_by_id", "severity", "status", "title") SELECT "category", "created_at", "description", "github_issue_url", "id", "page_url", "reporter_email", "reporter_id", "resolution_notes", "resolved_at", "resolved_by_id", "severity", "status", "title" FROM "bug_reports";
