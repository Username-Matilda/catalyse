...
CREATE TABLE "templates" (
    ...
    CONSTRAINT "templates_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "volunteers" ("id") ON DELETE SET NULL ON UPDATE NO ACTION,
    CONSTRAINT "templates_source_project_id_fkey" FOREIGN KEY ("source_project_id") REFERENCES "work_items" ("id") ON DELETE SET NULL ON UPDATE NO ACTION,
    CONSTRAINT "templates_source_team_id_fkey" FOREIGN KEY ("source_team_id") REFERENCES "teams" ("id") ON DELETE SET NULL ON UPDATE NO ACTION
);
...
CREATE TABLE "new_work_items" (
    ...
    CONSTRAINT "work_items_template_origin_id_fkey" FOREIGN KEY ("template_origin_id") REFERENCES "templates" ("id") ON DELETE SET NULL ON UPDATE NO ACTION,
...
INSERT INTO "new_work_items" ("assignee_id", "baseline_duration_days", "baseline_set_at", "baseline_start_date", "collaboration_link", "completed_at", "context_project_id", "country", "created_at", "creator_id", "deadline", "description", "duration_days", "estimated_duration", "estimated_hours", "featured_as_quick_task", "final_warning_sent_at", "id", "is_anchor", "is_org_proposed", "is_seeking_help", "local_group", "nudge_sent_at", "outcome", "outcome_notes", "parent_id", "project_type", "remote_eligibility", "review_notes", "review_rating", "reviewed_at", "reviewed_by_id", "schedule_updated_at", "skill_id", "sort_order", "stakeholder_id", "start_date", "started_at", "status", "team_id", "time_commitment_hours_per_week", "title", "type", "updated_at", "urgency") SELECT "assignee_id", "baseline_duration_days", "baseline_set_at", "baseline_start_date", "collaboration_link", "completed_at", "context_project_id", "country", "created_at", "creator_id", "deadline", "description", "duration_days", "estimated_duration", "estimated_hours", "featured_as_quick_task", "final_warning_sent_at", "id", "is_anchor", "is_org_proposed", "is_seeking_help", "local_group", "nudge_sent_at", "outcome", "outcome_notes", "parent_id", "project_type", "remote_eligibility", "review_notes", "review_rating", "reviewed_at", "reviewed_by_id", "schedule_updated_at", "skill_id", "sort_order", "stakeholder_id", "start_date", "started_at", "status", "team_id", "time_commitment_hours_per_week", "title", "type", "updated_at", "urgency" FROM "work_items";
